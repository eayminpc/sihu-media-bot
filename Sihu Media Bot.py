...
BOT_TOKEN = os.getenv("8743030512:AAHX-OTu9NSjtLpGRfybgrLBQP7bpW6spoI")
    ...
    try:
        ...
        if file_size > MAX_FILE_SIZE:
            ...
            await status.edit_text(
                ...
                "Please try a lower-quality or shorter video."
            )
